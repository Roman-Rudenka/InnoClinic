...
{
    public Task CreatePatientAsync(string firstName, string lastName, string? middleName, DateOnly birthDate, Guid accountId, CancellationToken cancellationToken);
    public Task<Patient> GetPatientByidAsync(Guid id, CancellationToken cancellationToken);
    public Task<Patient> GetByNameAsync(string? firstName, string? lastName, string? middleName, CancellationToken cancellationToken);
